...
TEST_CASE("attach_sock_addr_programs", "[sock_addr_tests]")
{
    ...
    bpf_program* recv_accept4_program = bpf_object__find_program_by_name(_globals.bpf_object.get(), "authorize_recv_accept4");
    ...
    bpf_program* recv_accept6_program = bpf_object__find_program_by_name(_globals.bpf_object.get(), "authorize_recv_accept6");
